...
| TradingView launch | `npm run tv:launch` (repo) or `/Applications/TradingView.app/Contents/MacOS/TradingView --remote-debugging-port=9222` |
| Node.js | v25.9.0 |
...
| Cloudflare account ID | `3c26eee30bc4f90d841016e831a3b29f` (Ops@aipunchlist — **not** the obsolete `68a2c4bd…` from early Session 2 docs) |
| KV namespace ID (prod) | `46cdb112832f47848a91a8f1109a0ebe` (`CF_KV_NAMESPACE_ID` / `KV_NAMESPACE_ID`) |
| KV preview ID | same as prod (see `session_notes_tv_session3.md`) |
